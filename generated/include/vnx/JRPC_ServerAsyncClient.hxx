...
#ifndef INCLUDE_vnx_JRPC_Server_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_JRPC_Server_ASYNC_CLIENT_HXX_
...
class JRPC_ServerAsyncClient : public vnx::AsyncClient {
public:
	JRPC_ServerAsyncClient(const std::string& service_name);
	
	JRPC_ServerAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_JRPC_Server_ASYNC_CLIENT_HXX_
