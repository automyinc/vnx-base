...
#ifndef INCLUDE_vnx_BaseServer_CLIENT_HXX_
#define INCLUDE_vnx_BaseServer_CLIENT_HXX_
...
class BaseServerClient : public vnx::Client {
public:
	BaseServerClient(const std::string& service_name);
	
	BaseServerClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_BaseServer_CLIENT_HXX_
