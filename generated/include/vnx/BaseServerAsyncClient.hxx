...
#ifndef INCLUDE_vnx_BaseServer_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_BaseServer_ASYNC_CLIENT_HXX_
...
class BaseServerAsyncClient : public vnx::AsyncClient {
public:
	BaseServerAsyncClient(const std::string& service_name);
	
	BaseServerAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_BaseServer_ASYNC_CLIENT_HXX_
