...
#ifndef INCLUDE_vnx_Recorder_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_Recorder_ASYNC_CLIENT_HXX_
...
class RecorderAsyncClient : public vnx::AsyncClient {
public:
	RecorderAsyncClient(const std::string& service_name);
	
	RecorderAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_Recorder_ASYNC_CLIENT_HXX_
