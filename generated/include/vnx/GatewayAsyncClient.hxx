...
#ifndef INCLUDE_vnx_Gateway_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_Gateway_ASYNC_CLIENT_HXX_
...
class GatewayAsyncClient : public vnx::AsyncClient {
public:
	GatewayAsyncClient(const std::string& service_name);
	
	GatewayAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_Gateway_ASYNC_CLIENT_HXX_
